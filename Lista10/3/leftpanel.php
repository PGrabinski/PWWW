...
if ($lastPath == 'browse.php' || $main == 'browse.php'){
  ...
  <button type="submit" class="btn btn-success mx-auto my-2" id="add">Filtruj</button>
  <button onclick="clear()" class="btn btn-success mx-auto my-2" id="clear">Wyczyść filtr</button>
</form>
<script>
  function clear(){
